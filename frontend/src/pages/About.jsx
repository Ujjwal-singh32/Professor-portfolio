...
const About = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 bg-gradient-to-r from-blue-200 to-purple-300 shadow-lg rounded-lg">
      {/* Header */}
      <h1 className="text-4xl font-bold text-center text-white drop-shadow-lg">About the Professor</h1>
      <p className="text-lg text-center text-gray-100 mt-2">A brief introduction to academic and research contributions.</p>
